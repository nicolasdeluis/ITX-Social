...
<head>
    ...
    <title>ITX Messenger - Login</title>
    <style>
        body {
            text-align: center;
...
<body>
    ...
    <p id="subtitle" style="font-size: 30px;">Anmelden:</p>
    ...
    <form method="POST">
        ...
        <div id="passwort-div">
            <input id="passwort-input" name="passwort" type="password" placeholder="" required />
    ...
    <script>
        ...
        function setLanguage(lang) {
            ...
            elements.loginButton.textContent = translations[lang].loginButton;
        }
